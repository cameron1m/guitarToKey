...
export declare type PluginTypeI = 'dataCollect' | 'dataAccess' | 'dataProcess' | 'modelLoad' | 'modelDefine' | 'modelTrain' | 'modelEvaluate';
/**
 * The base type which represents the `Record` from pipeline config file.
 */
export declare type ArgsType = InsertParams & Record<string, any>;
/**
